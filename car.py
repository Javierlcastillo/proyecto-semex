# put this as the very first import (optional but recommended)
...
# --- QLearner alias that always exists ---
class _QLearner:
    """Fallback stub; replaced by the real class if available."""
    def choose_action(self, *args, **kwargs):
        return None

try:
    # If your real Q-learner exists, override the stub with it
    from qlearner import QLearner as _QLearner  # type: ignore[no-redef]
except Exception:
    pass
